...
## 📁 Struktur Proyek
Tentu, ini adalah bagian penting untuk melengkapi repositori GitHub-mu. README yang baik akan menjelaskan proyekmu secara profesional kepada siapa saja yang melihatnya, termasuk dosenmu.

Saya sudah siapkan file README.md yang lengkap berdasarkan semua kode dan gambar yang telah kamu berikan.

Cara Menggunakan:
Buat file baru di dalam folder proyekmu dengan nama README.md.

Salin (copy) seluruh teks di bawah ini dan tempel (paste) ke dalam file README.md tersebut.

Upload file README.md ini ke repositori GitHub-mu. Halaman depan repositorimu akan otomatis menampilkannya dengan rapi.
